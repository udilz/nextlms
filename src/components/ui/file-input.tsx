...
const style = tv({
  slots: {
    base: "flex w-full items-center gap-2 overflow-hidden rounded-lg border border-slate-200 bg-white font-medium placeholder:font-normal focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 focus:outline-none",
    button:
